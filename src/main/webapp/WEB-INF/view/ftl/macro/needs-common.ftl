...
<tr>
  <th>指令编号</th>
  <td>
    <input class="form-control" name="demandReleaseCode" type="text" value="${demandReleaseModel.demandReleaseCode}" readonly>
  </td>
  ...
  <td>
    <input type="text" id="collectionTime" name="demandCollectionTime" class="form-control laydate-icon" value="${demandReleaseModel.demandCollectionTime?string("yyyy-MM-dd HH:mm:ss")}">
  </td>
</tr>
...
<tr>
  ...
  <td colspan="5">
    <input type="text" name="demandTitle" class="form-control" placeholder="指令标题" value="${demandReleaseModel.demandTitle}">
  </td>
</tr>
  ...
  <td colspan="5">
    <div class="u-form-checkbox-control">
      <div class="radio radio-info radio-inline">
        <input type="radio" id="general" value="1" name="emergencyLevel"<#if demandReleaseModel.emergencyLevel==1>checked="checked"<#else >checked="checked"</#if>>
        <label for="general">平急</label>
      </div>

      <div class="radio radio-warning radio-inline">
        <input type="radio" id="urgent" value="2" name="emergencyLevel" <#if demandReleaseModel.emergencyLevel==2>checked="checked"</#if>>
        <label for="urgent">紧急</label>
      </div>

      <div class="radio radio-danger radio-inline">
        <input type="radio" id="special" value="3" name="emergencyLevel" <#if demandReleaseModel.emergencyLevel==3>checked="checked"</#if>>
...
<tr>
  ...
  <th>发布时间</th>
  <td>
    <input type="text" name="createTime" class="form-control" value="${demandReleaseModel.createTime?string("yyyy-MM-dd HH:mm:ss")}" readonly>
  </td>
</tr>
...
<div class="row ibox-search">
  <div class="col-xs-10 col-md-11 form-inline search-input">
      <div class="input-group">
        ...
        <input type="text" id="startTime" name="startTime" class="form-control layer-date laydate-icon" placeholder="请输入开始时间">
      </div>
      <div class="input-group">
        <span class="input-group-addon">到</span>
        <input type="text" id="endTime" name="endTime" class="form-control layer-date laydate-icon" placeholder="请输入结束时间">
      </div>
      <div class="input-group">
  ...
  <div class="col-xs-2 col-md-1 u-btn-center">
      <button type="button" class="btn btn-success btn-lg btn-outline pull-right" id="btnQuery"><i class="fa fa-search"></i> 查询</button>
      <button type="button" class="btn btn-success btn-lg btn-outline pull-right" id="btnExport"><i class="fa fa-print"></i> 导出</button>
  </div>
</div>
<script>
