    ...
    <div class="col-sm-6 col-md-5">
        <div class="ibox ">
            ...
            <div class="ibox-content">
                ...
                <button type="button" class="btn btn-primary btn-outline btn-block btn-save-menu-list" style="margin-top: 20px;">
                    保存菜单顺序
                </button>
                <div class="m-t-md">
                    <h5>提示：</h5>
                ...
                <form class="form-horizontal menu-info">
                    ...
                    <table class="table table-bordered table-input">
                        <tr>
                            ...
                            <td><input id="menu-name" type="text" class="form-control v-req" maxlength="15" placeholder="请输入菜单名称"></td>
                        </tr>
                        <tr>
                            <th>提示信息</th>
                            <td><input id="menu-title" type="text" class="form-control" maxlength="50" placeholder="请输入菜单提示信息"></td>
                        </tr>
                        <tr>
                            <th class="required-input">菜单编号</th>
                            <td><input id="page-id" type="text" class="form-control v-req" maxlength="20" placeholder="请输入菜单编号"></td>
                        </tr>
                        <tr>
                            <th>菜单图标</th>
                            <td><input id="menu-icon" type="text" class="form-control" maxlength="50" placeholder="请选择菜单图标"></td>
                        </tr>
                        <tr>
                            <th>菜单图片</th>
                            <td><input id="menu-image" type="text" class="form-control" maxlength="256" placeholder="请输入菜单图片地址"></td>
                        </tr>
                        <tr>
                            <th class="required-input">菜单地址</th>
                            <td><input id="menu-url" type="text" class="form-control v-req" maxlength="256" placeholder="请输入菜单地址"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="u-form-checkbox-control">
                                    <div class="radio radio-info radio-inline" title="自动获取本子系统中的第一个有权限且非隐藏的菜单URL">
                                        <input type="radio" id="auto-smart-link" class="smart-link" name="smart-link" value="1" checked>
                                        <label for="auto-smart-link">智能获取</label>
                                    </div>

                                    <div class="radio radio-info radio-inline" title="使用【菜单地址】中指定的URL">
                                        <input type="radio" id="setting-smart-link" class="smart-link" name="smart-link" value="0">
                            ...
                            <td>
                                <div class="u-form-checkbox-control">
                                    <div class="radio radio-info radio-inline" title="在左侧导航栏中显示本菜单">
                                        <input type="radio" id="show-in-menu" class="menu-show" name="menu-show" value="1" checked>
                                        <label for="show-in-menu">显示菜单</label>
                                    </div>

                                    <div class="radio radio-info radio-inline" title="在左侧导航栏中隐藏本菜单">
                                        <input type="radio" id="hide-in-menu" class="menu-show" name="menu-show" value="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="menu-roles" class="form-control v-req" multiple="multiple" data-placeholder="请添加菜单权限">
                                    <option value=""></option>
                        ...
                        <tr>
                            ...
                            <td><textarea id="menu-memo" rows="5" class="form-control v-req" placeholder="请输入菜单说明"></textarea></td>
                        </tr>
                    </table>
                    <div class="form-group" style="margin-top: 20px;">
                        <div class="col-sm-6 col-sm-offset-3">
                            <button type="button" class="btn btn-outline btn-primary btn-block btn-save-menu-info">保存菜单信息</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        $('.dd').on('click', '.btn-delete', function () {
            ...
            layer.confirm(msg, {
                ...
                $.ajax({
                    ...
                    dataType   : 'json',
                    cache      : false,
                    data       : {DELETE : true, menuIds: menuIds
                    },
                    success    : function () {
                        bindMenuTreeData();
    ...
    <ol class="dd-list">
        ...
        <li class="dd-item" data-id="{{=m['menuId']}}">
            <span class="pull-right">
                <button type="button" class="btn btn-outline btn-primary btn-sm btn-edit" data-id="{{=m['menuId']}}">编辑</button>
                <button type="button" class="btn btn-outline btn-danger btn-sm btn-delete" data-id="{{=m['menuId']}}" data-name="{{=m['menuName']}}">删除</button>
            </span>
